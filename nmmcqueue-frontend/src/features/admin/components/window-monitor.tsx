...
import { useWindowMonitor } from "@/app/(admin)/_hooks/use-window-monitor";
...
export default function WindowMonitor() {
    ...
    const { windows, loading } = useWindowMonitor();
        ...
        <div className="w-full h-screen bg-slate-50 flex flex-col font-sans text-slate-800 overflow-hidden">
            ...
            <header className="bg-white shadow-md px-8 py-6 flex justify-between items-center sticky top-0 z-10 border-b-4 border-emerald-600 w-full shrink-0">
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        <h2 className="text-sm font-bold text-emerald-800 uppercase tracking-widest leading-none mb-1">CASHIER / REGISTRATION WINDOWS</h2>
                ...
                <div className="lg:col-span-5 flex flex-col gap-4 h-full overflow-hidden">
                    ...
                    <div className="flex-1 space-y-4 overflow-y-auto pr-2 pb-4">
                        {loading ? (
                            ...
                            <div className="p-12 text-center text-slate-400 font-bold uppercase tracking-widest">No active windows</div>
                                    ...
                                    <div className="w-[40%] flex items-center justify-center bg-white">
                                        {window.ticketNumber ? (
                                            <div className="flex flex-col items-center">
                                                ...
                                                <span className="text-[10px] font-bold text-emerald-500 uppercase tracking-widest">{window.priorityClass}</span>
                                            </div>
                                        ) : (
            ...
            <footer className="bg-emerald-950 py-3 px-8 shrink-0 overflow-hidden whitespace-nowrap">
                <div className="animate-marquee inline-block">
                    ...
                    <span className="text-emerald-400 font-black uppercase tracking-widest mx-12">Health is Wealth • Serbisyo Para sa Rakyat</span>
