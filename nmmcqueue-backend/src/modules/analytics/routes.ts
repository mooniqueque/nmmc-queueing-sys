...
analyticsRouter.get('/triage-snapshot', requireCapability('TRIAGE_VIEW'), async (req: Request, res: Response, next: NextFunction) => {
    try {
...
analyticsRouter.get('/window-snapshot', requireCapability('WINDOW_VIEW'), async (req: Request, res: Response, next: NextFunction) => {
    try {
...
analyticsRouter.get('/clinic-snapshot', requireCapability('CLINIC_VIEW'), async (req: Request, res: Response, next: NextFunction) => {
    try {
