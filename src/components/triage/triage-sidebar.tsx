...
import { MdDescription, MdLogout, MdMedicalServices, MdSupportAgent } from 'react-icons/md';
            ...
            <SidebarContent>
                <div className="p-4 flex items-center gap-2 mb-4">
                    ...
                    <div className="flex flex-col">
                        <span className="font-bold text-sm leading-tight text-emerald-950 ml-2"> NMMC Triage</span>
                    </div>
                </div>
                <SidebarGroup>
                    <SidebarGroupContent>
